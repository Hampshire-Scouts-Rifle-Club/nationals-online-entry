...
export const turningTarget: ShootingEvent = {
  ...
  summary: '',
  description: [
    `Turning Target Action is a fast-paced and exciting shooting competition that uses .22 semi-automatic scoped rifles.  Participants must have quick reflexes and good eyesight to achieve the best score over timed trials.  It’s a fun and challenging activity that requires skill to hit targets that are only exposed for a few seconds.`,
    '\n\nCourse of fire',
    '• Semi-auto .22 scoped rifle- 30 shots over three rapid-fire target exposures.  Competitors need to be 12 and over. ',
    '• Details are shot in the standing position or bench rest hand-held, depending on age.',
    '\n\nCategories',
    ...
    '\n\nMalfunctions and reshoots',
    '• If a competitor suffers from a rifle, ammunition or target malfunction, they will be granted a continuation detail at the range officer’s discretion.',
  ],
  slots: 1,
  cost: 15.5,
  minAge: 12,
